...
public class MQTTHelper {
    ...
    final String[] subscriptionTopic =
            new String[]{"dhl2k/f/bbc-led","dhl2k/f/bbc-humid","dhl2k/f/bbc-temp"};


    final String username = "dhl2k";
    final String password = "aio_XXJl85fsLoDxBsaKvfnQqBs6v04Y";
    ...
    private void subscribeToTopic() {
        try {
            ...
            String[] topics = new String[]{"dhl2k/f/bbc-led","dhl2k/f/bbc-humid","dhl2k/f/bbc-temp"};
